...
class ImageResultPage1 extends StatefulWidget {
  ...
  ImageResultPage1({required this.image, required this.descriptionText});
...
class _ImageResultPageState extends State<ImageResultPage1> with SingleTickerProviderStateMixin {
  ...
  List<String> _labels = []; // Stores extracted keys (labels)
  ...
  Map<String, dynamic> _extractedLabels = {}; // Store the full key-value map

  void _extractLabels() {
    try {
      print("🔍 Raw Description Data: ${widget.descriptionText}");
